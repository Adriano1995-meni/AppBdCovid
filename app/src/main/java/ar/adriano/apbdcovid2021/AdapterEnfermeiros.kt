...
class AdapterEnfermeiros (val fragment: ListaEnfermeirosFragment, var cursor: Cursor? = null)  : RecyclerView.Adapter<AdapterEnfermeiros.ViewHolderEnfermeiro>(){
    ...
    class AdapterLivros(val fragment: ListaLivrosFragment, var cursor: Cursor? = null) : RecyclerView.Adapter<AdapterLivros.ViewHolderLivro>() {
         ...
         * val fragment: ListaLivrosFragment, var cursor: Cursor? = null)
