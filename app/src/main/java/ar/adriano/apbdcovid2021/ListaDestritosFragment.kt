...
class ListaDestritosFragment :Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    fun processaOpcaoMenu(item: MenuItem): Boolean {
        ...
        when(item.itemId) {
            ...
            R.id.action_Novo -> navegaNovoDestrito()
            R.id.action_Alterar -> navegaAlterarDestrito()
            R.id.action_Eliminar -> navegaEliminarDestrito()
            else -> return false
        }
