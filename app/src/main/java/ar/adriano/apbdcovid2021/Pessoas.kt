...
data class Pessoas (
    ...
    var idDestrito: Long
     ...
     fun toContentValues(): ContentValues {
         ...
         valores.put(TabelaPessoas.DATA,dataTeste.time)
     ...
     companion object {
         fun fromCursor(cursor: Cursor): Pessoas {
             ...
             val  CorTest = cursor.getColumnIndex(TabelaPessoas.DATA)
             ...
             val CMP_ID = cursor.getLong(CampId)
             val IdCidade= cursor.getLong(CampoIdCidade)


             return Pessoas(id, Nome, Morada,Sexo , Date(Born)  ,contacto,  NifId, Date(Teste) ,CMP_ID,IdCidade)
         }
     }
